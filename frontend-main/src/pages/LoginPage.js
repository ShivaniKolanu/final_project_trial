        ...
        if(email.length === 0){
          ...
          alert("password has left Blank!");
            ...
            .then(function (response) {
                ...
                navigate(`/welcome?data=${encodeURIComponent(JSON.stringify(response.data))}`);
            })
              ...
              <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                <form>
                  ...
                  <div className="text-center text-lg-start mt-4 pt-2">
                    ...
                    <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an accounttt? <a href="/register" className="link-danger">Register</a></p>
                  </div>
